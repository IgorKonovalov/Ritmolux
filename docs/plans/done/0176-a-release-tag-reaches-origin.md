...
> `v0.123.0`, five assets; no release for the other nine; both workflows `active`. The `links` job's
> `--self-test` (4 of 4) and `--remote` steps first ran green on the close push, CI run `34854444537`.
> **Created:** 2026-09-14
