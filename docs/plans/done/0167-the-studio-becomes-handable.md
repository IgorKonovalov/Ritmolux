...
> **Status:** done 2026-09-11 — **closed short of its two `human` phases, by the owner's
> decision**, so the plan would not go stale. Phases 1-6 landed (`80fc61c`, `fbae516`, `2cd608a`,
> `a001a52`, `428a2ee` + `a967927`, `d033ce6`). Phase 7 (the tester handoff) never ran; Phase 8 ran
> its Windows half only (`67b7308`). Both are carried in the plans index under *Standing (not a
> plan)*. Close review: **no blockers, four majors, six minors, five nits**; ADR-0186 accepted,
> ADR-0187 accepted with an `Outcome`. This overrides the rule the Risks section below states.
> **Created:** 2026-09-10
...
> **Depends on:** [0159](0159-the-studio-opens.md) closed 2026-09-10 owing its two `human`
