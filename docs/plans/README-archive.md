...
**Every close write-up below is a heading rather than a bullet, so each one has an anchor**
(ADR-0163). Before Plan 0151 this file had four headings in 6,682 lines and nothing in it could
be linked to at all. The contents block is generated by `scripts/toc.mjs` and is never
hand-edited.
...
- [Recently closed (full entries)](#recently-closed-full-entries)
  ...
  - [0136 — The gates can convict](#0136--the-gates-can-convict)
  - [0137 — The metrics measure light](#0137--the-metrics-measure-light)
  - [0141 — The plugin's seams stop drifting](#0141--the-plugins-seams-stop-drifting)
  - [0139 — The render path validates before it spends](#0139--the-render-path-validates-before-it-spends)
  - [0146 — The preset sweeps stop being one long test](#0146--the-preset-sweeps-stop-being-one-long-test)
  - [0145 — The per-phase gate stops paying for the preset library](#0145--the-per-phase-gate-stops-paying-for-the-preset-library)
  - [0144 — The flags mean what they say](#0144--the-flags-mean-what-they-say)
  - [0125 — The scenes share their GPU boilerplate](#0125--the-scenes-share-their-gpu-boilerplate)
  - [0124 — The review fixes that move no pixels](#0124--the-review-fixes-that-move-no-pixels)
  - [0135 — The show-night surfaces stop lying](#0135--the-show-night-surfaces-stop-lying)
  - [0131 — The operator gets a console](#0131--the-operator-gets-a-console)
  - [0134 - The lanes stop sharing a store](#0134---the-lanes-stop-sharing-a-store)
  - [0115 — The engine becomes a live video source](#0115--the-engine-becomes-a-live-video-source)
  - [0104 — The library stops being lopsided](#0104--the-library-stops-being-lopsided)
  - [0129 — The build stops being paid three times](#0129--the-build-stops-being-paid-three-times)
  - [0132 — The lighting rig follows the visuals](#0132--the-lighting-rig-follows-the-visuals)
  - [0130 — The audio input becomes an operator surface](#0130--the-audio-input-becomes-an-operator-surface)
  - [0122 — Every rate integrates](#0122--every-rate-integrates)
  - [0098 — The figure nests properly](#0098--the-figure-nests-properly)
  - [0118 — The comments stop narrating the plans that wrote them](#0118--the-comments-stop-narrating-the-plans-that-wrote-them)
  - [0087 — The line renderer draws a curve](#0087--the-line-renderer-draws-a-curve)
  - [0114 — The line stroke reads as a drawn line](#0114--the-line-stroke-reads-as-a-drawn-line)
  - [0119 — The flatness gate gets its second term](#0119--the-flatness-gate-gets-its-second-term)
  - [0113 — The engine paints a canvas](#0113--the-engine-paints-a-canvas)
  - [0116 — The sanity lens finds the ground](#0116--the-sanity-lens-finds-the-ground)
  - [0117 — The downbeat log sees the counter it folds over](#0117--the-downbeat-log-sees-the-counter-it-folds-over)
  - [0095 — The downbeat fold gets a musical beat](#0095--the-downbeat-fold-gets-a-musical-beat)
  - [0106 — The frame stream passes through a diffusion model](#0106--the-frame-stream-passes-through-a-diffusion-model)
  - [0112 — The handoff stops being a chat message](#0112--the-handoff-stops-being-a-chat-message)
  - [0111 — The MilkDrop import stops washing out](#0111--the-milkdrop-import-stops-washing-out)
  - [0110 — The shader surface stops being invisible](#0110--the-shader-surface-stops-being-invisible)
  - [0107 — The foobar menu picks a preset](#0107--the-foobar-menu-picks-a-preset)
  - [0108 — The MilkDrop import gets its tone back](#0108--the-milkdrop-import-gets-its-tone-back)
  - [0101 — The engine renders a music video](#0101--the-engine-renders-a-music-video)
  - [0100 — The engine speaks MilkDrop](#0100--the-engine-speaks-milkdrop)
...
- [0121 — A rate, an ink edge, and a motion reading (closed 2026-08-27)](#0121--a-rate-an-ink-edge-and-a-motion-reading-closed-2026-08-27)
  ...
  - [0127 — The picture stops depending on the volume slider (closed 2026-08-28)](#0127--the-picture-stops-depending-on-the-volume-slider-closed-2026-08-28)
  - [Superseded sequencing note - Plan 0129 (archived 2026-08-29 at its close)](#superseded-sequencing-note---plan-0129-archived-2026-08-29-at-its-close)
<!-- toc:end -->
...
repaired.** Version **0.135.0** (minor). ADR-0219 and ADR-0220 accepted, neither with an `Outcome`.
