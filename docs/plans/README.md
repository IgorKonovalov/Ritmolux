...
| # | Plan | Why here |
|---|------|----------|
| 1 | [0078](0078-the-ink-learns-to-bite.md) | Small — slots into any free session; ends with the content lane re-judging the ink worlds. |
| 2 | [0079](0079-the-attractor-learns-new-figures.md) | Largest, two `human` curation gates inside. |
