...
| [0169](0169-a-preset-is-checked-before-it-is-rendered.md) | A preset is checked before it is rendered | in-progress | dev, human | ADR-0190 (proposed): `--check` reuses the loader, **nothing formats a preset**. Phases 1-3 landed; Phase 4 failed, amended 2026-09-13: one editor schema per system (Phases 5-6). |
