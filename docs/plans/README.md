...
- [0098 — The figure nests properly](done/0098-the-figure-nests-properly.md) — closed 2026-08-27. Review: **no blockers, no majors, five minors, two nits.** Version: **0.84.0** (minor). Closed [backlog 0096 + 0097](../design-backlog.md), filed 0143. [Write-up](README-archive.md).
