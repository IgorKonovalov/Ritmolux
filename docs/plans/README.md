...
| [0166](0166-the-basics-read-in-russian.md) | The basics read in Russian | draft | dev, human | ADR-0183: five docs gain a Russian sibling `.ru.md` stamped with the source sha. **Phase 3 is a `human` review that blocks publication.** Touches no Rust - orderable against any lane. |
<!-- roster:end -->
