...
| [0229](0229-the-conductor-reports-itself-honestly.md) | The conductor reports itself honestly | approved | dev | Approved and queued 2026-09-24 at the owner's call, though Phase 4 widens settings.conductor.json. Four self-misdescriptions: an unnamed flaky test, a settled park called live, a stale process, moot denials. |
<!-- roster:end -->
