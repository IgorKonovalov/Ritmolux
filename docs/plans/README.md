...
| [0107](0107-the-foobar-menu-picks-a-preset.md) | The foobar menu picks a preset | draft | dev, human | Carries [ADR-0117](../adrs/0117-c-abi-v6-the-host-reads-the-roster-and-selects-a-preset.md) (ABI v6). Contends with [0103](0103-the-project-gets-an-audience.md) Phase 1 on the menu handler - run in sequence. |
