...
| # | Plan | Why here |
|---|------|----------|
| 1 | [0077](0077-the-quiet-sky.md) | First of the three promoted handoff plans: the sparse idiom becomes gateable before more sparse content is authored against the old statistic. |
| 2 | [0078](0078-the-ink-learns-to-bite.md) | Small — slots into any free session; ends with the content lane re-judging the ink worlds. |
| 3 | [0079](0079-the-attractor-learns-new-figures.md) | Largest, two `human` curation gates inside. |
