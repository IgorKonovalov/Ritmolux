...
**Next free number: 0167** (ADRs are a separate sequence — next free there is **0184**.)
...
| [0166](0166-the-basics-read-in-russian.md) | The basics read in Russian | approved | dev, human | ADR-0183: five docs gain a Russian sibling `.ru.md` stamped with the source sha. **Phase 3 is a `human` review that blocks publication.** Touches no Rust - orderable against any lane. |
<!-- roster:end -->
