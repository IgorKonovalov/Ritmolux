...
**Next free number: 0217** (ADRs are a separate sequence — next free there is **0239**; 0200 is reserved for Plan 0186 Phase 2.)
...
| [0216](0216-the-operator-owns-the-order.md) | The operator owns the order | draft | dev | ADR-0239 (proposed): two rotation orders, each on a row and a hotkey, and `source` likewise. The shuffle seed stops being the embedded preset count - takes 0205 finding 5. |
<!-- roster:end -->
