...
**Next free number: 0196** (ADRs are a separate sequence — next free there is **0216**; 0200 is reserved for Plan 0186 Phase 2.)
...
| [0195](0195-a-finding-can-be-closed.md) | A finding can be closed | draft | dev | ADR-0216 (proposed): one command records a dated disposition, the page carries the open and counts the closed. Nothing but a human may write one. |
<!-- roster:end -->
