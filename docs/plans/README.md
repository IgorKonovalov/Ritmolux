...
its own `human` verdict with a defect already known about. [0081](0081-the-sky-gets-a-galaxy.md) is
...
**The suite is 27 baselines, not 20** (repaired 2026-08-12 at [0080](done/0080-the-sky-gets-a-horizon.md)'s
close, which found the paragraph and the plan it had been copied into both saying "20" against a
directory holding 26). The eight drifters are named above by label, so the numerator survives the
...
- **The banding reference frame is kept in the repo, and it is owed a re-measure twice**
  ...
  **1920x1080** (plateau width is in pixels, so the resolution is part of the measurement). The
  ...
  second: after [0081](0081-the-sky-gets-a-galaxy.md), with `bg_band_amount` added, confirm the
  dither still holds under **two overlapping gradients** — which nothing inside 0081 otherwise
  checks. Its README carries the run command and both sets of numbers.
- **Plan [0080](done/0080-the-sky-gets-a-horizon.md) Phase 7 — ANSWERED 2026-08-12, and it
  ...
  - **The plan said "if it bands, a dither is its own decision and its own ADR" — so it has one.**
    ...
    user's call and **closed 2026-08-12**, so [0081](0081-the-sky-gets-a-galaxy.md)'s band is born
