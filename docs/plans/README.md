...
| # | Plan | Why here |
|---|------|----------|
| 1 | [0075] | **Last by design** (ADR-0089): the fresh library is authored once, against a finished engine. **[0076] closed 2026-08-11, so cohort 6 (the collage) is unblocked** — the lane's remaining work is cohort 6 and the Phase 6 doc sweep. |
