...
| [0131](0131-the-linux-standalone-captures-through-pulseaudios-simple-api.md) | The Linux standalone captures system audio through PulseAudio's simple API, on a third platform arm | accepted 2026-09-22 (Plan 0120) |
...
| [0135](0135-every-scene-rate-integrates-through-one-shared-phase.md) | Every scene rate integrates through one shared `Phase`, and a guard asserts it | accepted 2026-08-28 (Plan 0122), extended by 0152 |
...
| [0140](0140-a-sample-budget-is-a-density-against-the-render-target.md) | An attractor's sample budget is a density against the render target, capped live and uncapped offline | accepted 2026-08-28 (Plan 0128), amended by 0195, Outcome |
...
| [0146](0146-one-name-selects-the-gpu-and-each-side-matches-its-own-roster.md) | One name selects the GPU, and each side matches its own roster | accepted 2026-08-30 (Plan 0115), Outcome, refines 0125, supplemented by 0246 |
...
| [0155](0155-the-window-takes-the-adapter-and-the-preset-the-operator-names.md) | The window takes the adapter and the preset the operator names | accepted 2026-08-31 (Plan 0144), refines 0146 + 0148, amended by 0246 |
...
| [0165](0165-dependencies-compile-without-debug-info-and-one-line-buys-it-back.md) | Dependencies compile without debug info, and one line buys it back | accepted 2026-09-07 (Plan 0153); extended by 0204 |
| [0166](0166-a-published-document-splits-into-routes-by-size.md) | A published document splits into routes by size, and a fragment map is the contract | accepted 2026-09-05 (Plan 0154), Outcome; extends 0154; extended by 0247 |
...
| [0193](0193-a-test-that-reads-the-clock-runs-alone.md) | A test that reads the clock runs alone, and the lint exemption that marks it is what selects it | accepted 2026-09-14 (Plan 0174), Outcome; extends 0173; extended by 0204, 0205 |
...
| [0205](0205-an-approved-plan-runs-under-a-conductor-and-every-judgement-it-cannot-make-parks-the-plan.md) | An approved plan runs under a conductor, and every judgement it cannot make parks the plan | accepted 2026-09-14 (Plan 0187), Outcome; supersedes 0188 in part; amended by 0207, 0208, 0209, 0214 |
...
| [0207](0207-a-suite-run-the-conductor-observed-green-is-not-run-again-on-the-same-tree.md) | A suite run the conductor observed green is not run again on the same tree | accepted 2026-09-16 (Plan 0189), amends 0205, 0156, Outcome; amended by 0211 |
...
| [0209](0209-a-conductor-close-repairs-the-prose-and-comments-its-findings-name.md) | A conductor close repairs the prose and comments its findings name | accepted 2026-09-16 (Plan 0189), amends 0205, Outcome; superseded in part by 0210, amended by 0216 |
...
| [0247](0247-the-split-recurses-and-the-ceiling-is-an-assertion-about-the-corpus.md) | The split recurses, and the ceiling is an assertion about the corpus | accepted 2026-09-24 (Plan 0225), Outcome; extends 0166 |
| [0248](0248-the-pipeline-repairs-before-it-parks.md) | The pipeline repairs before it parks: a readiness check at the front, one repair per red, and a close split from its review | proposed 2026-09-24, Plan 0226; amends 0205 |
| [0249](0249-a-human-phase-may-be-owed-after-the-merge.md) | A human phase marked as not blocking the merge is owed after it, not waited for | proposed 2026-09-24, Plan 0226; amends 0205 |
| [0250](0250-the-conductor-stays-up-and-resumes-what-the-repository-shows-settled.md) | The conductor stays up, waits instead of stopping, and resumes what the repository shows settled | proposed 2026-09-24, Plan 0226; amends 0205, 0214, 0219 |
<!-- roster:end -->
