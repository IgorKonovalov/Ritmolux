...
| [0244](0244-the-npm-graphs-are-gated-like-the-cargo-graph-and-an-install-script-runs-by-name.md) | The npm graphs are gated like the cargo graph, and an install script runs by name | accepted 2026-09-24, Plan 0220, Outcome |
| [0245](0245-an-internal-grid-is-a-fraction-of-the-target-resolved-per-tier-and-adapter-class.md) | An internal grid is a fraction of the render target, resolved per tier and adapter class, and the sample budget counts against the grid | accepted 2026-09-26 (Plan 0223), Outcome; supplements 0034, 0140 |
