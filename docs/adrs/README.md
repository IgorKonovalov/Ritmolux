...
| [0031](0031-post-stage-trait-instantiable-composite-chain.md) | Post-composite stages behind a `PostStage` trait; the composite becomes an instantiable ordered `PostChain` (fixed order preserved, not a graph) — a third internal seam, unblocks 0024's dual-live | proposed |
