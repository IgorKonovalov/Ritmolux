...
**Next free number: 0128.** *(0120 was reserved for
...
| [0126](0126-the-sanity-lens-measures-departure-from-the-frames-own-ground.md) | The sanity lens measures departure from the frame's own ground, not from black | proposed 2026-08-25 (Plan 0116), Outcome, completed by 0127 |
| [0127](0127-a-tonally-flat-picture-is-a-blot-only-if-it-is-also-structureless.md) | A tonally flat picture is a blot only if it is also structureless | proposed 2026-08-26 (Plan 0116) |
<!-- roster:end -->
