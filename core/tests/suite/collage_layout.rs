...
//!
//! `RLX_SAMPLE_DIR=<dir> cargo test -p rlx-core --test suite collage_layout::`
//! writes the sheet there and prints the path. Without the variable the sweep still runs
