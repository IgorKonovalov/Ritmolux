...
struct Present {
    ...
    // (ADR-0078), z: palette_contour_style (integral, rounded CPU-side),
...
fn fs_main(in: VsOut) -> @location(0) vec4<f32> {
    ...
    let mixed = band_contour_ink(
        ...
        coord, pp.d.x, pp.d.y, pp.d.z, pp.d.w, lut_a, lut_b, lut_samp, palette_mix
    );
...
struct PresentParams {
    ...
    c: [f32; 4],
    /// x: palette_steps, y: palette_contour (ADR-0078), z: palette_contour_style,
    /// w: palette_contour_ink (ADR-0197).
    d: [f32; 4],
}
        ...
        queue.write_buffer(
            ...
            bytemuck::bytes_of(&PresentParams {
                ...
                d: [
                    ...
                    palette::band_contour_style(colour.contour_style),
                    colour.contour_ink,
                ],
            }),
        );
