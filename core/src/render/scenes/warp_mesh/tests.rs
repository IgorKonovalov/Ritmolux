//! The warp mesh's CPU-side contracts (Plan 0100 Phase 1). GPU-free throughout:
//! everything asserted here is arithmetic, a roster, or a clamp — the pixels are
//! the golden guard's business.
