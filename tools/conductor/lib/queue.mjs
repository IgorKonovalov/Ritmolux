...
//   { "budget_usd": { "implement": 5, "fix": 3, "review": 4, "close": 3, "merge": 2, "repair": 3 }, "run_budget_usd": 60, "max_open_worktrees": 3 }
...
const PLAN = /^[0-9]{4}$/;
const STEP_KINDS = ["implement", "fix", "review", "close", "merge", "repair"];
